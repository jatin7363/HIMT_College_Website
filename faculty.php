	...
	<div id="container" class="clear">
		...
		<div id="content" class="msg">
			...
			<p>
				...
				Compulsory Seminars: It is mandatory for all students to participate in seminars on wide variety of topics related to the curriculum, once a week.</p>
			<p>
			...
			<table style="padding-left:30px">
				<caption>
					<Center><b>
							<font size=3><u>List of Faculty</u>
								<font></font>
						</b></Center>
				</caption>
				<tbody>
					...
					<tr>
						<td>Dr. Hitesh Dhall</td>
						<td>Director</td>
					</tr>
					<tr>
						<td colspan="2"><b>
								<center>MCA Faculty</center>
							</b></td>
					</tr>
					<tr>
